...
export const buildPayloadFromSteps = (steps) => {
  ...
  const repeat_on = (steps.timeDetails?.repeatDays || ["Monday", "Wednesday", "Friday"]).map(day => dayMapping[day] || day)
  ...
  if (steps.careCategory === 'Childcare') {
    ...
    payload.details.provider_experience_requirements = {
      communication_and_language: steps.experience?.communicationLanguage || ["Fluent in English"],
      special_preferences: steps.experience?.specialPreferences || [],
      preferred_option: steps.experience?.preferredOption || ["Live-Out"],
      additional_care_categories: steps.experience?.additionalCareCategories || []
    }
